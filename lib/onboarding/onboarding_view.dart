...
//import 'package:finance_tracker/Components/color.dart';
          ...
          children: [
            ...
            SmoothPageIndicator(
                ...
                effect: const WormEffect(
                  dotHeight: 12,
                  dotWidth: 12,
                  activeDotColor: Color.fromARGB(255, 90, 90, 145),
                ),
            ),
 ...
 Widget getStarted(){
    return Container(
      decoration: BoxDecoration(
        ...
        color: const Color.fromARGB(255, 82, 57, 126)
      ),
      ...
      child: TextButton(
          ...
          child: const Text("Get started",style: TextStyle(color: Color.fromARGB(255, 255, 255, 255)),)),
    );
 }
}
